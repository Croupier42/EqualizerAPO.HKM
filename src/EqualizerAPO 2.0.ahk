	...
	if !FileExist(CFG)
	{
		...
		MsgBox, 4,, Добавить конфигурационный файл в Equalizer APO?, 5
			IfMsgBox Yes
			{
				...
				{
					ADD_CFG := SubStr(A_ScriptFullPath, 1, -3)"txt"
					FileAppend, `nInclude: %ADD_CFG%, %EqAPO_CFG%
				}
				else
				{
